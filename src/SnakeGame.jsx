...
class SnakeGame extends React.Component {
	...
	tryToEatApple() {
		...
		if (snake[0].Xpos === apple.Xpos && snake[0].Ypos === apple.Ypos) {
            ...
            this.setState({snake, apple, score: this.state.score + 1, highScore, newHighScore, gameLoopTimeout});
		}
	}
				...
				style={{width: this.state.width, height: this.state.height, borderWidth: this.state.width / 50}}>
					{this.state.snake.map((snakePart, index) => {
						return (
							...
							left: snakePart.Xpos, top: snakePart.Ypos,
					...
					/>
				<div className='Score'
				style={{ fontSize: this.state.width / 20 }}>
